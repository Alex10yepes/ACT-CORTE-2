...
public class Usuarios {
    ...
    public int guardarUsuario(String Nombre, String Apellido, String Username, String Email, 
                             String Sexo, String Telefono, String Clave) throws SQLException {
        Conector db = new Conector();
        db.conectar();
        String query = "INSERT INTO usuarios (Nombre, Apellido, Username, Email, Sexo, Telefono, clave) "
                     + "VALUES (?, ?, ?, ?, ?, ?, ?)";
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Sexo, Telefono, Clave);
    }
    ...
    public int actualizarUsuario(int id, String Nombre, String Apellido, String Username, String Email, 
        ...
        String query = "UPDATE usuarios SET Nombre = ?, Apellido = ?, Username = ?, Email = ?, "
                     + "Cargo = ?, Telefono = ?, clave = ? WHERE id = ?";
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Sexo, Telefono, Clave, id);
    }
